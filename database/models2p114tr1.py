...
t_ActionPropertyType_2 = Table(
    'ActionPropertyType_2', metadata,
...
t_ActionType1 = Table(
    ...
    Column('DELETED', INTEGER(1)),
    Column('CLASS', INTEGER(1)),
    Column('GROUP_ID', INTEGER(11)),
    Column('CODE', String(15)),
    Column('NAME', Text),
    Column('TITLE', Text),
    Column('FLATCODE', String(64)),
    Column('SEX', INTEGER(4)),
    Column('AGE', String(9)),
    Column('OFFICE', String(32)),
    Column('SHOWINFORM', INTEGER(1)),
    Column('GENTIMETAB', INTEGER(1)),
    Column('QUOTATYPE_', INTEGER(11)),
    Column('CONTEXT', String(64)),
    Column('AMOUNT', Float(10, True)),
    Column('AMOUNTEVAL', INTEGER(1)),
    Column('DEFAULTSTA', INTEGER(4)),
    Column('DEFAULTDIR', INTEGER(4)),
    Column('DEFAULTPLA', INTEGER(1)),
    Column('DEFAULTEND', INTEGER(4)),
    Column('DEFAULTEXE', INTEGER(11)),
    Column('DEFAULTSET', INTEGER(10)),
    Column('DEFAULTPER', INTEGER(4)),
    Column('DEFAULTPER1', INTEGER(4)),
    Column('DEFAULTMKB', INTEGER(1)),
    Column('DEFAULTMOR', INTEGER(1)),
    Column('ISMORPHOLO', INTEGER(1)),
    Column('DEFAULTORG', INTEGER(11)),
    Column('SHOWTIME', INTEGER(1)),
    Column('MAXOCCURSI', INTEGER(11)),
    Column('ISMES', INTEGER(11)),
    Column('NOMENCLATI', INTEGER(11)),
    Column('ISPREFERAB', INTEGER(1)),
    Column('PRESCRIBED', INTEGER(11)),
    Column('SHEDULE_ID', INTEGER(11)),
    Column('ISREQUIRED', INTEGER(1)),
    Column('ISNOMENCLA', INTEGER(1)),
    Column('HASASSISTA', INTEGER(1)),
    Column('PROPERTYAS', INTEGER(1)),
    Column('PROPERTYUN', INTEGER(1)),
    Column('PROPERTYNO', INTEGER(1)),
    Column('PROPERTYEV', INTEGER(1)),
    Column('SERVICETYP', INTEGER(1)),
    Column('ACTUALAPPO', INTEGER(6)),
    Column('ISSUBSTITU', INTEGER(1)),
    Column('ISPRINTED', INTEGER(1)),
    Column('DEFAULTMES', INTEGER(4)),
    Column('FREQUENCYC', INTEGER(11)),
    Column('FREQUENCYP', INTEGER(4)),
    Column('FREQUENCYP1', INTEGER(4)),
    Column('ISSTRICTFR', INTEGER(1)),
    Column('ISFREQUENC', INTEGER(4)),
    Column('COUNTER_ID', INTEGER(11)),
    Column('ISCUSTOMSU', INTEGER(1)),
    Column('RECOMMENDA', INTEGER(11)),
    Column('RECOMMENDA1', INTEGER(1)),
    Column('ISEXECREQU', INTEGER(1)),
    Column('LOCKED', INTEGER(1))
)


t_ActionTypeEGISZ = Table(
    'ActionTypeEGISZ', metadata,
    Column('id', INTEGER(11)),
    Column('code', String(50)),
    Column('name', Text),
    Column('actual', INTEGER(11)),
    Column('deleteDate', String(255)),
    Column('deleted', INTEGER(11))
)


class ActionTypeEGISZ2(Base):
    __tablename__ = 'ActionTypeEGISZ2'
    __table_args__ = {'comment': 'Справочник Номенклатура медицинских услуг - 1.2.643.5.1.13.13.11.1070'}

    id = Column(INTEGER(11), primary_key=True)
    code = Column(Text, nullable=False)
    name = Column(Text, nullable=False)
    actual = Column(TINYINT(1), nullable=False, server_default=alchemy_text("1"))
    deleteDate = Column(Text, nullable=False)
    deleted = Column(TINYINT(1), nullable=False, server_default=alchemy_text("0"))


class ActionType09022018(Base):
    __tablename__ = 'ActionType_09022018'
    ...
    defaultExecPerson_id = Column(INTEGER(11))
    defaultSetPerson_id = Column(INTEGER(10))
    ...
    defaultOrg_id = Column(INTEGER(11))
    ...
    nomenclativeService_id = Column(INTEGER(11))
    isPreferable = Column(TINYINT(1), nullable=False, server_default=alchemy_text("1"))
    prescribedType_id = Column(INTEGER(11))
    shedule_id = Column(INTEGER(11))
    ...
    lis_code = Column(String(32), server_default=alchemy_text("'NULL'"))
    ...
    refferalType_id = Column(INTEGER(11))
...
class Event(Base):
    ...
    isIllegalActions = Column(TINYINT(1), server_default=alchemy_text("0"))
...
class EventTypeAction09022018(Base):
    __tablename__ = 'EventType_Action_09022018'
    ...
    tissueType_id = Column(INTEGER(11))
    sex = Column(TINYINT(4), nullable=False)
    age = Column(String(9), nullable=False)
...
class Organisation(Base):
    ...
    checkNumberLen = Column(TINYINT(1), server_default=alchemy_text("0"))
...
t_Organisation_51 = Table(
    'Organisation_51', metadata,
...
class Person(Base):
    ...
    DN = Column(TINYINT(1), nullable=False, server_default=alchemy_text("0"))
    checkAttach = Column(TINYINT(1))
    post_netrica_code = Column(String(64))
    post_EGISZ_code = Column(String(64))
    orgstructure_netrica_code = Column(String(64))
    orgstructure_EGISZ_code = Column(String(64))
    availableAppointmentForNonresident = Column(INTEGER(11), server_default=alchemy_text("0"))
...
class Referral(Base):
    ...
    cancelReasonOther = Column(INTEGER(11))
    notes = Column(Text)
...
t_antonov_paid_services = Table(
    'antonov_paid_services', metadata,
...
t_client1 = Table(
    ...
    Column('column5', String(50)),
    Column('column6', String(50)),
    Column('column7', Date),
...
t_client_2 = Table(
    ...
    Column('Фамилия', Text),
    Column('Имя', Text),
    Column('Отчество', Text),
    Column('ДР', Text),
    Column('П', Text),
    Column('Док.', Text),
    Column('Сер.Док.', Text),
    Column('N.Док.', INTEGER(11)),
    Column('Ст.комп.', Text),
    Column('Сер.Пол.', Text),
    Column('N.Пол.', Float(asdecimal=True)),
    Column('Проп.', Text),
    Column('UN_House', INTEGER(11)),
    Column('Кв-ра', INTEGER(11)),
    Column('Телефон', Text),
    Column('Дог.Страх', Text),
    Column('Дог.Закр', Text),
    Column('Филиал', Text),
    Column('Дата выд пол', Text),
    Column('Дата действ пол', Text),
    Column('Дата действ пасп', Text),
    Column('БАЗ.ТМО', Text),
    Column('БАЗ.П-КА', Text),
    Column('ТМО ПРИКР.', Text),
    Column('П-КА ПРИКР.', Text),
    Column('Г/С', INTEGER(11)),
    Column('РАБОТАЕТ', Text),
    Column('СОЦ.ГРУППА', Text),
    Column('ДИАГН.', Text),
    Column('ПРИМ.', Text),
    Column('ДАТА ОТКР', Text),
    Column('ADDR1', Text),
    Column('UN_HOUSE2', INTEGER(11)),
    Column('КВ2', INTEGER(11)),
    Column('ADDR2', Text),
    Column('МЕСТО ВЫДАЧИ', Text),
    Column('ДАТА ВЫДАЧИ', Text),
    Column('TEL2', INTEGER(11)),
    Column('OPER', Text),
    Column('NAMEWORK', Text),
    Column('СОЦ.СТАТУС', Text),
    Column('КАТЕГОРИЯ', Text),
    Column('N пенс.уд.', Text),
    Column('GRAGD', INTEGER(11)),
    Column('PRSURNAME', Text),
    Column('PRNAME1', Text),
    Column('PRNAME2', Text),
    Column('PRDRSTR', Text),
    Column('PRVID', Text),
    Column('PRTYPEDOC', Text),
    Column('PRSERDOC', Text),
    Column('SNILS', Text),
    Column('PRSEX', Text),
    Column('PRNDOC', Text),
    Column('MESTOR', Text),
    Column('VPOLIS', INTEGER(11)),
    Column('TEL3', Text)
)
...
t_medical_and_social_expertise_preferred_form = Table(
    'medical_and_social_expertise_preferred_form', metadata,
    Column('ID', INTEGER(11), nullable=False),
    Column('NAME', String(50)),
    Column('NAME_088_488_551', String(50)),
    Column('CODE', INTEGER(11))
)
...
t_price19 = Table(
    'price19', metadata,
    Column('code', String(255)),
    Column('code1', String(255)),
    Column('name', LONGTEXT),
    Column('price_old', Float(10, True)),
    Column('price_new', Float(10, True))
)
...
t_pso_po31 = Table(
    'pso_po31', metadata,
    Column('vid_p', String(50)),
    Column('s_pol', String(50)),
    Column('n_pol', String(50)),
    Column('enp', String(50)),
    Column('datebeg', String(50)),
    Column('fam', String(50)),
    Column('im', String(50)),
    Column('ot', String(50)),
    Column('dr', DateTime),
    Column('w', String(50)),
    ...
    Column('phone', String(255)),
    Column('phone_s', String(255)),
    Column('e_mail', String(255)),
    Column('doctype', String(50)),
    Column('doc_type_name', String(100)),
    Column('docser', String(50)),
    Column('docnumber', INTEGER(11)),
    Column('docdata', String(50)),
    Column('docend', String(50)),
    Column('dockemv', String(50)),
    Column('Телефон', String(50)),
    Column('Адрес регистрации', String(100)),
    Column('Адрес фактический', String(100)),
    Column('Дата_выписки', DateTime),
    Column('Медицинская_организация', String(50))
)


t_pso_po39 = Table(
    'pso_po39', metadata,
    Column('vid_p', INTEGER(11)),
    Column('s_pol', String(50)),
    Column('n_pol', INTEGER(11)),
    Column('enp', String(50)),
    Column('datebeg', String(50)),
    Column('fam', String(50)),
    Column('im', String(50)),
    ...
    Column('dr', DateTime),
    Column('w', INTEGER(11)),
    Column('snils', String(255)),
    Column('phone', String(255)),
    Column('phone_s', String(255)),
    Column('e_mail', String(255)),
    Column('doctype', INTEGER(11)),
    Column('doc_type_name', String(50)),
    Column('docser', String(50)),
    Column('docnumber', INTEGER(11)),
    Column('docdata', String(50)),
    Column('docend', String(50)),
...
class RbBenefitsCategory(Base):
    __tablename__ = 'rbBenefitsCategories'
    __table_args__ = {'comment': 'Льготные категории населения - справочник: 1.2.643.5.1.13.13.99.2.43'}

    id = Column(INTEGER(10), primary_key=True)
    group_level = Column(INTEGER(10), nullable=False, server_default=alchemy_text("0"))
    skl = Column(MEDIUMTEXT)
    name = Column(MEDIUMTEXT)
    group_id = Column(INTEGER(10))
    region_code = Column(MEDIUMTEXT)
    OKOGU = Column(MEDIUMTEXT)
    mos_id = Column(MEDIUMTEXT)
    code = Column(INTEGER(10))


class RbBio(Base):
    __tablename__ = 'rbBio'
    __table_args__ = {'comment': 'Федеральный справочник лабораторных исследований. Справочник лабораторных материалов и образцов {1.2.643.5.1.13.13.11.1081} v2.4'}

    id = Column(INTEGER(11), primary_key=True)
    code = Column(INTEGER(11))
    group = Column(String(255))
    matter = Column(String(255))
...
class RbCancellationReasonOther(Base):
    __tablename__ = 'rbCancellationReasonOther'
...
class RbDrugTherapyType(Base):
    __tablename__ = 'rbDrugTherapyType'
    __table_args__ = {'comment': 'Справочник для Лекарственной Терапии'}

    id = Column(INTEGER(11), primary_key=True)
    code = Column(String(8), nullable=False)
    name = Column(String(150), nullable=False)
    NOTFULLDSH = Column(String(8), nullable=False)
...
class RbEGISZHealthGroup(Base):
    __tablename__ = 'rbEGISZHealthGroup'
    __table_args__ = {'comment': 'Группы здоровья'}
...
class RbFinance(Base):
    ...
    EGISZ_shortName = Column(String(128))
...
class RbIEMKDocument(Base):
    ...
    netrica_Code = Column(String(5), nullable=False, server_default=alchemy_text("''"))
    type = Column(String(10), nullable=False, server_default=alchemy_text("''"))
...
t_rbInstrumentalResearchMethods = Table(
    'rbInstrumentalResearchMethods', metadata,
    Column('id', INTEGER(11)),
    Column('name', String(255)),
    Column('code', String(255)),
    comment='rbInstrumentalResearchMethods - справочник: 1.2.643.5.1.13.13.11.1472'
)
...
t_rbKlinGroup = Table(
    'rbKlinGroup', metadata,
    Column('id', INTEGER(11)),
    Column('code', String(16), server_default=alchemy_text("'''NULL'''")),
    Column('name', String(255), server_default=alchemy_text("'''NULL'''")),
    Column('EGISZ_code', INTEGER(11))
)
...
class RbMedCarePlace(Base):
    __tablename__ = 'rbMedCarePlace'
    __table_args__ = {'comment': 'Место оказания медицинской помощи (1.2.643.5.1.13.13.11.1008)'}
...
t_rbProfessionsPositions = Table(
    'rbProfessionsPositions', metadata,
    Column('id', INTEGER(11)),
    Column('group', INTEGER(11), server_default=alchemy_text("1")),
    Column('name', Text),
    Column('code', Text),
    Column('okz', Text),
    comment='Классификатор профессий рабочих и должностей служащих - справочник: 1.2.643.5.1.13.2.1.1.658'
)
...
t_rbReferralType_EGISZ = Table(
    'rbReferralType_EGISZ', metadata,
    Column('id', INTEGER(11), nullable=False),
    Column('code', String(255)),
    Column('name', String(255)),
...
class RbUserProfile(Base):
    ...
    code = Column(String(16), nullable=False)
    name = Column(String(128), nullable=False)
    tmRoleProfile_id = Column(ForeignKey('rbTmRoleProfile.id'))
    ...
    tmRoleProfile = relationship('RbTmRoleProfile')
...
class RbeEGISZRegion(Base):
    __tablename__ = 'rbeEGISZRegion'
    __table_args__ = {'comment': 'Субъекты Российской Федерации'}
...
t_rbfactdetection = Table(
    'rbfactdetection', metadata,
    Column('id', INTEGER(11)),
    Column('code', String(255), server_default=alchemy_text("'NULL'")),
    Column('name', String(255), server_default=alchemy_text("'NULL'"))
)


t_rbfactorriskZNO = Table(
    'rbfactorriskZNO', metadata,
    Column('id', INTEGER(11)),
    Column('code', String(255), server_default=alchemy_text("'NULL'")),
    Column('name', String(255), server_default=alchemy_text("'NULL'")),
    Column('Ball', String(255)),
    Column('Code MKB', String(255))
)
...
t_rbsiptomZNO = Table(
    'rbsiptomZNO', metadata,
    Column('id', INTEGER(11)),
    Column('code', String(255), server_default=alchemy_text("'NULL'")),
    Column('name', String(255), server_default=alchemy_text("'NULL'")),
    Column('text', String(255), server_default=alchemy_text("'NULL'")),
    Column('code MKB-10', String(255), server_default=alchemy_text("'NULL'"))
)
...
class TempFileC(Base):
    __tablename__ = 'tempFileC'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `C` (КК)'}
    ...
    importDateTime = Column(DateTime, nullable=False, server_default=alchemy_text("current_timestamp()"))
    number = Column(INTEGER(11), nullable=False, server_default=alchemy_text("0"))


class TempFileD(Base):
    __tablename__ = 'tempFileD'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `D` (КК)'}
...
class TempFileI(Base):
    __tablename__ = 'tempFileI'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `I` (КК)'}
...
class TempFileN(Base):
    __tablename__ = 'tempFileN'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `N` (КК)'}
...
class TempFileO(Base):
    __tablename__ = 'tempFileO'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `O` (КК)'}
...
class TempFileP(Base):
    __tablename__ = 'tempFileP'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `P` (КК)'}
    ...
    RKEY = Column(String(50))
    FKEY = Column(String(50))
    status = Column(TINYINT(4), nullable=False, server_default=alchemy_text("0"))
    importDateTime = Column(DateTime, nullable=False, server_default=alchemy_text("current_timestamp()"))
    number = Column(INTEGER(11), nullable=False, server_default=alchemy_text("0"))


class TempFileR(Base):
    __tablename__ = 'tempFileR'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `R` (КК)'}
...
class TempFileU(Base):
    __tablename__ = 'tempFileU'
    __table_args__ = {'comment': 'Таблица для импорта файла выгрузки `U` (КК)'}
...
t_x = Table(
    ...
    Column('SERVICE_ID', INTEGER(11)),
    Column('REGIONALCO', String(8)),
    Column('EISCODE', String(8)),
    Column('NETRICA_CO', String(8))
)
...
t_z = Table(
    ...
    Column('FEDERALCOD', String(16)),
    Column('NETRICA_CO', String(64)),
    Column('NETRICA_CO1', String(64))
)


t_ДМС_изм_цен = Table(
    'ДМС изм цен', metadata,
    Column('code', String(20), nullable=False, server_default=alchemy_text("'0'")),
    Column('name', String(150), nullable=False, server_default=alchemy_text("'0'")),
    Column('price', INTEGER(10), nullable=False, server_default=alchemy_text("0"))
)


t_ДМС_лаб_исс_ = Table(
    'ДМС лаб.исс.', metadata,
    Column('code', String(10), nullable=False, server_default=alchemy_text("'0'")),
    Column('name', String(150), nullable=False, server_default=alchemy_text("'0'")),
    Column('price', INTEGER(10), nullable=False, server_default=alchemy_text("0"))
)


t_профили_помощи_новые_2020 = Table(
    'профили_помощи_новые_2020', metadata,
    Column('Код', INTEGER(11)),
    Column('Наименование', String(150)),
    Column('Тип направления', String(50)),
    Column('Родительский профиль, коды', String(50)),
    Column('Родительский профиль, наименования', String(100)),
    Column('Код родительского профиля', INTEGER(11))
)
...
class ActionTemplate(Base):
    ...
    action_id = Column(INTEGER(11))
    actionsTypesId = Column(LONGTEXT)
...
class RbVimisDiagnosi(Base):
    __tablename__ = 'rbVimisDiagnosis'
    __table_args__ = {'comment': 'IMP-926: ВИМИС. Диагнозы МКБ-10 {1.2.643.2.69.1.1.1.165}, {1.2.643.2.69.1.1.1.167}, {1.2.643.2.69.1.1.1.168}'}

    id = Column(INTEGER(11), primary_key=True)
    mkbTree_id = Column(ForeignKey('MKB_Tree.id'), nullable=False)
    type = Column(String(10), nullable=False, server_default=alchemy_text("''"))

    mkbTree = relationship('MKBTree')
...
class ActionType(Base):
    ...
    instrumentalId = Column(INTEGER(11))
...
class EventType(Base):
    ...
    showCreatedEvents = Column(TINYINT(1), server_default=alchemy_text("0"))
...
class OrgStructureHospitalBed(Base):
    ...
    paidFlag = Column(TINYINT(1), server_default=alchemy_text("0"))
    isTempBusy = Column(SMALLINT(6), nullable=False, server_default=alchemy_text("0"))
...
class RbResult(Base):
    ...
    netrica_HospResult_code = Column(String(4))
...
class ActionPropertyType(Base):
    ...
    autoFillAutoField = Column(TINYINT(4), server_default=alchemy_text("0"))
...
class BlankTempInvalidParty(Base):
    ...
    issuedOrgStructureId = Column(ForeignKey('OrgStructure.id'))
...
class ClientBenefit(Base):
    __tablename__ = 'ClientBenefits'
    __table_args__ = {'comment': 'Льготы пациента'}
    ...
    modifyDatetime = Column(DateTime, nullable=False)
    modifyPerson_id = Column(ForeignKey('Person.id'))
    deleted = Column(BIT(3), nullable=False)
    client_id = Column(ForeignKey('Client.id'), nullable=False)
    benefitCategory_id = Column(ForeignKey('rbBenefitsCategories.id'))
    parent_id = Column(ForeignKey('rbBenefitsCategories.id'))
    begDate = Column(Date)
    endDate = Column(Date)
    notes = Column(TINYTEXT)

    benefitCategory = relationship('RbBenefitsCategory', primaryjoin='ClientBenefit.benefitCategory_id == RbBenefitsCategory.id')
    client = relationship('Client')
    createPerson = relationship('Person', primaryjoin='ClientBenefit.createPerson_id == Person.id')
    modifyPerson = relationship('Person', primaryjoin='ClientBenefit.modifyPerson_id == Person.id')
    parent = relationship('RbBenefitsCategory', primaryjoin='ClientBenefit.parent_id == RbBenefitsCategory.id')
...
class ClientRelation(Base):
    ...
    freeInput = Column(String(80))
    legal_representative = Column(INTEGER(11), server_default=alchemy_text("0"))
...
class ClientWork(Base):
    ...
    workPost = Column(INTEGER(11))
    workType = Column(INTEGER(11))
...
class Diagnosi(Base):
    ...
    setDate = Column(Date)
    endDate = Column(Date, nullable=False)
    mod_id = Column(ForeignKey('Diagnosis.id'), ForeignKey('Diagnosis.id', ondelete='CASCADE'))
    person_id = Column(ForeignKey('Person.id'))
...
class EventTypeDiagnostic(Base):
    ...
    service_id = Column(ForeignKey('rbService.id', ondelete='SET NULL'))
    defaultEndDateCode = Column(INTEGER(11), server_default=alchemy_text("0"))
...
class TakenTissueJournal(Base):
    ...
    tissueType_id = Column(ForeignKey('rbTissueType.id', ondelete='SET NULL'), ForeignKey('rbTissueType.id', ondelete='CASCADE'))
    externalId = Column(String(30), nullable=False)
    number = Column(String(30), nullable=False)
    amount = Column(INTEGER(11), nullable=False, server_default=alchemy_text("0"))
    unit_id = Column(ForeignKey('rbUnit.id', ondelete='SET NULL'))
...
class Diagnostic(Base):
    ...
    org_id = Column(INTEGER(11))
    defaultEndDate_Code = Column(INTEGER(11), server_default=alchemy_text("0"))
    date_registration = Column(Date)
    diagnosisRationale_id = Column(INTEGER(11))
    diagnosisNosologyType_id = Column(INTEGER(11))
    tnm = Column(INTEGER(11))
    diagnosisPrimaryPluralTumor_id = Column(INTEGER(11))
    diagnosisAffectedSide_id = Column(INTEGER(11))
    diagnosisTumorTopography_id = Column(INTEGER(11))
    diagnosisMetastasesLocalization_id = Column(INTEGER(11))
...
class ExportFileF(Base):
    __tablename__ = 'ExportFileF'
    __table_args__ = {'comment': 'Таблица для ФЛК (КК)'}

    id = Column(INTEGER(11), primary_key=True)
    clientpolicy_id = Column(ForeignKey('ClientPolicy.id', ondelete='SET NULL', onupdate='CASCADE'))
    event_id = Column(ForeignKey('Event.id', ondelete='SET NULL', onupdate='CASCADE'))
    FKEY = Column(String(50))
    CODE_MO = Column(String(5))
    PL_OGRNF = Column(String(15))
    FIOF = Column(String(30))
    IMAF = Column(String(20))
    OTCHF = Column(String(30))
    POLF = Column(String(1))
    DATRF = Column(Date)
    SNILSF = Column(String(14))
    C_DOC = Column(DECIMAL(2, 0))
    S_DOC = Column(String(10))
    N_DOC = Column(String(15))
    DATN = Column(Date)
    DATO = Column(Date)
    SPVF = Column(INTEGER(1))
    SPSF = Column(String(20))
    SPNF = Column(String(20))
    OKATO_OMSF = Column(String(5))
...
class TempInvalidNumbersStore(Base):
    ...
    master_id = Column(ForeignKey('BlankTempInvalid_Party.id'))

    master = relationship('BlankTempInvalidParty')
...
class ActionEGISZ(Base):
    __tablename__ = 'Action_EGISZ'
    __table_args__ = {'comment': 'Услуги НМУ для Action'}

    id = Column(INTEGER(11), primary_key=True)
    action_id = Column(ForeignKey('Action.id', ondelete='CASCADE'), nullable=False)
    EGISZ_id = Column(ForeignKey('ActionTypeEGISZ2.id', ondelete='CASCADE'))

    EGISZ = relationship('ActionTypeEGISZ2')
    action = relationship('Action')
...
class JobTicketSignedDocument(Base):
    ...
    id = Column(INTEGER(11), primary_key=True)
    jobTicket_id = Column(ForeignKey('Job_Ticket.id', ondelete='CASCADE'), nullable=False)
    template_id = Column(ForeignKey('rbPrintTemplate.id', ondelete='CASCADE'), nullable=False)
    person_id = Column(ForeignKey('Person.id', ondelete='CASCADE'), nullable=False)
    datetime = Column(DateTime, nullable=False, server_default=alchemy_text("current_timestamp()"))
    ...
    jobTicket = relationship('JobTicket')
    person = relationship('Person')
    template = relationship('RbPrintTemplate')
...
class AccountItem(Base):
    ...
    workedOut = Column(TINYINT(1), server_default=alchemy_text("0"))
...
class AccountRefus(Base):
    ...
    refuseName = Column(String(264))
    file = Column(String(200))
    status = Column(TINYINT(1), nullable=False, server_default=alchemy_text("1"))
